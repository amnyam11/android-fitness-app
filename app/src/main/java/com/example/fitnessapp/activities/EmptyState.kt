...
import com.example.fitnessapp.fragments.Activity
import com.example.fitnessapp.fragments.Profile
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .add(R.id.fragment_container, Activity(), "ActivityFragment")
                .commit()
        }
        ...
        bottomNavigationView.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.navigation_activity -> {
                    switchFragment(Activity(), "ActivityFragment")
                    true
                }

                R.id.navigation_profile -> {
                    switchFragment(Profile(), "ProfileFragment")
                    true
                }
